...
sons = {
    ...
    "tiro": Sound("som/disparo.ogg"),
    "soco": Sound("som/soco.ogg"),
...
while rodando:   
    ...
    if state == "comeco":
        ...
        if Soco_Ativo:
            ...
            elif not soco_ja_hitou: # Aqui é pra bater num inimigo só
    ...
    if mouse_livre != mouse_anterior:
        if not mouse_livre:
            click_menu.play()
        else:
            click_menu.pause()
            pass
    mouse_anterior = mouse_livre
